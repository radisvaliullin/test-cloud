...
func main() {
	...
	resp, err := client.Services.Skus.List("services/02DA-B362-D983").Context(ctx).Do()
	if err != nil {
		log.Fatalf("billing, services list skus err - %v\n", err)
	}
	log.Printf("billing, services list skus - %+v", resp)
}
