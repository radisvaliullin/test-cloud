...
func main() {
	...
	resp, err := client.Projects.GetBillingInfo(name).Context(ctx).Do()
	if err != nil {
		log.Printf("billing, get projects bill info err - %v\n", err)
	}
	log.Printf("billing, get projects bill info - %+v", resp)
}
